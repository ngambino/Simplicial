...
We now introduce the  comprehension category that will be the focus of
our development.  We refer to~\cite{JacobsB:catltt,LumsdaineP:locuoc} for the definition of a comprehension category  and related notions.  Let $\SSet_{\mathsf{cof}}$ be the full subcategory of $\SSet$ spanned by
...
\begin{proof}  The category $\SSet^\to_{\mathsf{cof}}$ is the associated arrow category, whose objects are
...
We conclude this section with some auxiliary results on cofibrations.
