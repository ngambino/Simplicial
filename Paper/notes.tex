...
extended with the Univalence Axiom (UA)  in the category of simplicial sets~\cite{voevodsky-simplicial-model}.  This model is of fundamental importance since it has informed a new approach to the development of mathematics and its computer-assisted formalisation~\cite{voevodsky:library} and has been one of
the sources of inspiration for the rapid development of Homotopy Type Theory~\cite{hottbook}.
...
\mathbf{Fib}\,  \ar[dr] \ar@{>->}[rr] & & \SSet^{\to} \ar[dl]^{\mathrm{cod}} \\ 
 ...
 \end{gathered}
\]
where $\SSet$ is the category of simplicial sets $\SSet$
