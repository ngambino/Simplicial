...
fibration, which holds by part~(ii) of~\cref{thm:lemma-for-u}. 
\end{enumerate}
\end{proof} 
...
\begin{proof} Part (i) follows immediately as $\U_c$ is the cofibrant replacement of $\U$,
which has been shown to be fibrant in part~(i) of~\cref{thm:fibrancy-and-univalence-of-u}.
Part~(ii) follows from part (ii) of~\cref{thm:lemma-for-uc} exactly in the 
same way as \cref{thm:fibrancy-and-univalence-of-u} follows from by part~(ii) of~\cref{thm:lemma-for-u}. 
\end{proof}
