...
\displaystyle A[f] \coprod_B B \times \Delta[1] \coprod_B A[f] \ar[d] \ar[r]  & A[f] \ar[d] \\
...
Since the maps $p_i \co A_i \rightarrow X$ (for $i = 1, 2$) are fibrations with cofibrant domain, \cref{cor:Pi_types_are_fibrant} implies that pullbacks of trivial cofibration between cofibrant objects 
\caution{along such 
