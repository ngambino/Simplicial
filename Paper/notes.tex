...
Since Martin-L\"of type theory is a constructive theory and its proof-theoretic strength is 
much lower than that of Zermelo-Fraenkel set theory~\cite{RathjenM:strsml}, it is natural to ask whether the simplicial model could be defined working in a constructive setting, such as 
Martin-L\"of type theory itself or Constructive Zermelo-Fraenkel set theory~\cite{AczelP:typtic}. This
...
the closure of Kan complexes under exponentiation is not provable constructively.
...
sets but only those with decidable degeneracies. Another proof of the constructive existence of this
model structure was obtained in~\cite{GambinoN:anocp}.
...
Univalence Axiom. In particular, we prove:
\begin{itemize}
\item
\item
\item
