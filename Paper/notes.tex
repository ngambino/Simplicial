...
model structure on the category of simplicial sets whose fibrations are the Kan fibrations, 
 the fact that dependent product along fibrations preserves fibrations 
...
\section{A fibration classifying small fibrations between bifibrant objects}
\label{sec:unifbb}
